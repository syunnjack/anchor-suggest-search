...
const postKey = 'anchor-suggest-search.posts'
const savedKey = 'anchor-suggest-search.saved'
const items = [
  {
    "id": "anchor-suggest-search-1",
    "title": "Nagoya product opportunity",
    "category": "product",
    "area": "Nagoya",
    "summary": "SEO/AIO internal-link and suggested-search generator for comparison pages, local pages and product clusters. This page is designed as a searchable seed record with review intent, update status and conversion context.",
    "score": 92,
    ...
    "revenue": "SEO lead gen"
  },
  {
    "id": "anchor-suggest-search-2",
    "title": "Tokyo service opportunity",
    "category": "service",
    "area": "Tokyo",
    "summary": "SEO/AIO internal-link and suggested-search generator for comparison pages, local pages and product clusters. This page is designed as a searchable seed record with review intent, update status and conversion context.",
    "score": 85,
    ...
    "revenue": "comparison ads"
  },
  {
    "id": "anchor-suggest-search-3",
    "title": "Osaka shop opportunity",
    "category": "shop",
    "area": "Osaka",
    "summary": "SEO/AIO internal-link and suggested-search generator for comparison pages, local pages and product clusters. This page is designed as a searchable seed record with review intent, update status and conversion context.",
    "score": 78,
...
function App() {
  ...
  const [form, setForm] = useState({ title: '', category: 'product', body: '' })
  ...
  function submitPost(event) {
    ...
    setForm({ title: '', category: 'product', body: '' })
  }
  ...
  return (
    <main className="app-shell">
      <section className="hero">
        <div>
          <span className="brand">anchorsuggest.jp / anchor-suggest-search</span>
          <h1>Anchor Suggest Search</h1>
          <p>SEO/AIO internal-link and suggested-search generator for comparison pages, local pages and product clusters.</p>
        </div>
        <aside className="answer-box">
          <small>AI overview answer</small>
          <strong>Anchor Suggest Search helps users compare, verify and act faster.</strong>
      ...
      <section className="ugc-section">
        ...
        <form className="ugc-form" onSubmit={submitPost}>
          ...
          <select value={form.category} onChange={(event) => setForm({ ...form, category: event.target.value })}>
            {["product","service","shop","local","FAQ"].map((item) => <option key={item}>{item}</option>)}
          </select>
